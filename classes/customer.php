...
<?php
    class customer
    {
        ...
        public function insert_binhluan() {
            $productId = $_POST['pro_id_binhluan'];
            ...
            if($tenbinhluan == "" || $binhluan == "" ) {
                ...
                $query = "INSERT INTO tbl_comment(tenbinhluan,binhluan,productId) 
        ...
        public function login_customers($data) {
            ...
            if($email == "" || $password == "" ) {
                ...
                if($result_check != FALSE) {
                    ...
                    $alert = "<span class='success'>Email or Password doesn't match</span>";
                    return $alert;
                }
            }
        }
